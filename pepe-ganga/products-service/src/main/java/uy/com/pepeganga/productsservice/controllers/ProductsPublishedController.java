...
public class ProductsPublishedController {
    ...
    public ResponseEntity<PageDeatilsPublicationMeli> getPublicationsDetailsBySellerProfile(@PathVariable Integer profileId, @RequestParam int page, @RequestParam int size){
